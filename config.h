...
/* tagging */
static const char *tags[] = {"n", "e", "i", "o", "a", "r", "s", "t", "g"};
...
static const char *incvol[] = {"/usr/bin/pulsemixer", "--change-volume", "+5",
                               NULL};
static const char *decvol[] = {"/usr/bin/pulsemixer", "--change-volume", "-5",
                               NULL};
...
static const Key keys[] = {
    ...
    {SUPERKEY, XK_f, spawn, {.v = filemanagercmd}},
    ...
    // -0.05} }, { MODKEY,                       XK_Left,      setmfact, {.f =
    // +0.05} },
    {MODKEY, XK_f, zoom, {0}},
    ...
    TAGKEYS(XK_n, 0) TAGKEYS(XK_e, 1) TAGKEYS(XK_i, 2) TAGKEYS(XK_o, 3)
        TAGKEYS(XK_a, 4) TAGKEYS(XK_r, 5) TAGKEYS(XK_s, 6) TAGKEYS(XK_t, 7)
            TAGKEYS(XK_g, 8) TAGKEYS(XK_1, 0) TAGKEYS(XK_2, 1) TAGKEYS(XK_3, 2)
                TAGKEYS(XK_4, 3) TAGKEYS(XK_5, 4) TAGKEYS(XK_6, 5)
                    TAGKEYS(XK_7, 6) TAGKEYS(XK_8, 7)
                        TAGKEYS(XK_9, 8){SUPERKEY | ShiftMask, XK_q, quit, {0}},
